              ...
              <form class="register" method="post">
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                    <label class="mr-sm-2" for="exampleUsername">Username</label>
                    <input type="text" class="form-control form-control-user" id="exampleUsername" name="username" placeholder="Username">
                  </div>
                </div>
                <div class="form-group">
                  <label class="mr-sm-2" for="exampleInputName" >Nama lengkap</label>
                  <input type="text" class="form-control form-control-user" name="nama" id="exampleInputName" placeholder="Name">
                </div>
                <div class="form-group">
                  <label class="mr-sm-2" for="exampleInputPassword">Password</label>
